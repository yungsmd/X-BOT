...
zokou({
  ...
  const quoteMessage = "\n◆━━━━━━✦QUOTE✦━━━━━━◆ \n◇ _" + quoteData.quote.body + "_\n\n\n◇ *AUTHOR:* " + quoteData.quote.author + "\n\n\n\n\n◇ _Engine by:_ *BELTAH HACKING TEAM🎭*\n\n\n╔═════◇\n║◇ *THANK YOU FOR LOVING SCENE-MD BOT*\n╚════════════════════> ";
...
zokou({
  ...
  try {
    ...
    const lyricsMessage = "*SCENE-MD LYRICS FINDER*\n\n*TITLE* - " + title + "\n\n*ARTIST* - " + artist + "\n\n" + lyrics;
    await sender.sendMessage(message, {
      'image': {
        'url': "./media/lyrics.jpg"
      },
      'caption': lyricsMessage by BELTAH TECH 
    }, {
      'quoted': metadata
    });
  } catch (error) {
